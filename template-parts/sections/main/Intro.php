...
$text = getThemeField('introText', 'Компания VK Smart Service поможет закупить и доставить ваш груз даже с самой сложной логистикой из любой части света. Обратитесь к экспертам своего дела, которые предоставят вам исчерпывающие консультации, окажут качественные услуги и предложат надёжные решения для любых задач.');
?>
<section class="intro" id="intro">
	<div class="intro__inner container">
		...
		<img class="intro__media" src="<?php echo esc_url(getThemeAssetUri('images/intro/intro-photo.jpg')); ?>" alt="">
	</div>
</section>
